    ...
    md:gap-28 lg:py-20 xl:flex-row '>
      <div className='hero-map'/>
        <div className='relative z-20 flex flex-1 flex-col xl:w-1/2 '>
          ...
          <h1 className='bold-52 lg:bold-88'>Molikhark Camp</h1>
          <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>A unique camping experience</p>
            ...
            <div className='flex flex-col'>
              <div className='flexBetween'>
                <div className='flex flex-col'>
                  ...
                  <p className='bold-20 text-white'>Rudranath</p>
                </div>
